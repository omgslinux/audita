...
#[Route('/report/privatization/servicecentralization', name: 'app_report_privatization_services_central_')]
class ServiceCentralizationController extends AbstractController
{
